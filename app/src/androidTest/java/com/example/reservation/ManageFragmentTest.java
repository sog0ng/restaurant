...
public class ManageFragmentTest {
    ...
    @Test
    public void manageFragmentTest() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editid),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("yoo"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatImageButton = onView(
                allOf(withContentDescription("Open navigation drawer"),
                        childAtPosition(
                                allOf(withId(R.id.owner_toolbar),
                                        childAtPosition(
        ...
        ViewInteraction editText = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        editText.perform(replaceText("11111111"), closeSoftKeyboard());
